      ...
      <div className="container" style={{ maxWidth: '1020px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                  <h2 style={{ color: '#F8FAFC', fontSize: '1.25rem', fontWeight: '800' }}>
        ...
        <div style={{
          ...
          <div className="glass-panel" style={{ padding: '30px' }}>
            <h3 style={{ color: '#F8FAFC', fontSize: '1.25rem', fontWeight: '700', marginBottom: '8px' }}>
            ...
            {submitted ? (
              <div style={{ textAlign: 'center', padding: '36px 10px' }}>
                ...
                <p style={{ color: '#94A3B8', fontSize: '0.88rem', marginBottom: '20px' }}>
                  Reference ID: <strong style={{ color: '#38BDF8', fontFamily: 'var(--font-mono)' }}>#SFYN-{Date.now().toString().slice(-6)}</strong>
                </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div className="glass-panel" style={{ padding: '30px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px', marginBottom: '12px' }}>
                  <button
                    ...
                    style={{
                      ...
                      padding: '6px',
                      borderRadius: '6px',
                      border: apiType === 'enterprise' ? '1px solid #38BDF8' : '1px solid transparent',
                      backgroundColor: apiType === 'enterprise' ? 'rgba(56, 189, 248, 0.15)' : 'transparent',
                      color: apiType === 'enterprise' ? '#38BDF8' : '#94A3B8',
                      fontSize: '0.78rem',
                      fontWeight: '600',
                      cursor: 'pointer'
                    }}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: '6px',
                      borderRadius: '6px',
                      border: apiType === 'law_enforcement' ? '1px solid #FBBF24' : '1px solid transparent',
                      backgroundColor: apiType === 'law_enforcement' ? 'rgba(251, 191, 36, 0.15)' : 'transparent',
                      color: apiType === 'law_enforcement' ? '#FBBF24' : '#94A3B8',
                      fontSize: '0.78rem',
                      fontWeight: '600',
                      cursor: 'pointer'
                    }}
              ...
              {/* Sample API Request */}
              <div style={{ fontSize: '0.76rem', color: '#94A3B8', marginBottom: '8px' }}>Example cURL Request:</div>
  ...
  -d '{"url": "http://bescom-bill.top", "emulate": "mobile"}'`}
            ...
            <div className="glass-panel" style={{ padding: '24px' }}>
              ...
              <p style={{ fontSize: '0.82rem', color: '#94A3B8', lineHeight: '1.5' }}>
                For official law enforcement inquiries or emergency ISP domain blocking orders, contact our 24x7 security operations center at <strong style={{ color: '#F8FAFC' }}>ops@sfynbox.gov.in</strong>.
              </p>
            </div>
          </div>
