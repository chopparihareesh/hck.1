    ...
    <div className="cyber-bg" style={{ minHeight: '100vh', padding: '40px 20px 80px' }}>
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)', fontWeight: '800', color: '#F8FAFC', marginBottom: '8px' }}>
            {t.scanner.heading}
          </h1>
        ...
        <div style={{ maxWidth: '980px', margin: '0 auto 30px' }}>
          ...
          >
            <div style={{
              ...
              <Terminal size={22} color="#38BDF8" style={{ flexShrink: 0 }} />
              <input
                type="text"
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
              ...
              >
                <ClipboardPaste size={15} color="#38BDF8" />
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.76rem', color: '#94A3B8' }}>Preset Scenarios:</span>
            {SCAM_PRESETS.map((preset) => (
              <button
                key={preset.id}
                onClick={() => handleSelectPreset(preset)}
                style={{
                  background: url === preset.url ? 'rgba(56, 189, 248, 0.18)' : 'rgba(26, 26, 30, 0.8)',
                  border: url === preset.url ? '1px solid #38BDF8' : '1px solid rgba(255, 255, 255, 0.1)',
                  boxShadow: '0 1px 3px rgba(0, 0, 0, 0.3)',
                  color: preset.riskLevel === 'critical' ? '#F87171' : (preset.riskLevel === 'suspicious' ? '#FBBF24' : '#34D399'),
                  padding: '4px 10px',
                  borderRadius: '6px',
                  fontSize: '0.74rem',
                  fontWeight: '600',
              ...
              return (
                <div 
                  ...
                  style={{
                    ...
                    padding: '12px',
                    borderRadius: '8px',
                    backgroundColor: isCurrent ? 'rgba(56, 189, 248, 0.12)' : (isCompleted ? 'rgba(16, 185, 129, 0.12)' : 'rgba(26, 26, 30, 0.7)'),
                    border: isCurrent ? '1px solid #38BDF8' : (isCompleted ? '1px solid rgba(16, 185, 129, 0.4)' : '1px solid rgba(255, 255, 255, 0.08)'),
                ...
                >
                  <div style={{
                    ...
                    height: '24px',
                    borderRadius: '50%',
                    backgroundColor: isCompleted ? '#10B981' : (isCurrent ? '#0284C7' : '#334155'),
                    color: '#FFFFFF',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                  ...
                  <div>
                    <div style={{
                      ...
                      color: isCurrent ? '#38BDF8' : (isCompleted ? '#F8FAFC' : '#94A3B8')
                    }}>
                      {step.title}
                    </div>
                  </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                <div style={{
                  ...
                  height: '52px',
                  borderRadius: '12px',
                  backgroundColor: activeResult.riskLevel === 'critical' ? 'rgba(220, 38, 38, 0.15)' : (activeResult.riskLevel === 'suspicious' ? 'rgba(217, 119, 6, 0.15)' : 'rgba(5, 150, 105, 0.15)'),
                ...
                <div>
                  ...
                  <h3 style={{ fontSize: '1.25rem', color: '#F8FAFC', fontWeight: '700', wordBreak: 'break-all' }}>
                    {activeResult.url}
                  </h3>
                </div>
              </div>
            ...
            <div style={{
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#F8FAFC', fontSize: '0.88rem', fontWeight: '600' }}>
                    <Eye size={16} color="#38BDF8" />
                    <span>{t.scanner.screenshotTitle}</span>
                  </div>
                  <span style={{ fontSize: '0.72rem', color: '#10B981', fontWeight: '600' }}>Isolated Sandbox</span>
                </div>
                ...
                <div style={{ fontSize: '0.74rem', color: '#94A3B8', textAlign: 'center', marginTop: '10px' }}>
                    ...
                    {accordionOpen.domain && (
                      <div style={{ padding: '0 14px 14px', fontSize: '0.8rem', color: '#94A3B8' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
                          ...
                          <strong style={{ color: activeResult.riskLevel === 'critical' ? '#F87171' : '#F8FAFC' }}>
                            {activeResult.forensics?.domainAge}
                          </strong>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
                          <span>Registrar:</span>
                          <span style={{ color: '#F8FAFC' }}>{activeResult.forensics?.registrar}</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0' }}>
                          <span>{t.scanner.ipLocation}:</span>
                          <span style={{ color: '#F8FAFC' }}>{activeResult.forensics?.hostIp} ({activeResult.forensics?.geoCountry})</span>
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    {accordionOpen.ssl && (
                      <div style={{ padding: '0 14px 14px', fontSize: '0.8rem', color: '#94A3B8' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
                          ...
                          <span style={{ color: '#F8FAFC' }}>{activeResult.forensics?.sslIssuer}</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0' }}>
                          <span>Autonomous System:</span>
                          <span style={{ color: '#F8FAFC' }}>{activeResult.forensics?.asn}</span>
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    {accordionOpen.form && (
                      <div style={{ padding: '0 14px 14px', fontSize: '0.8rem', color: '#94A3B8' }}>
                        <div style={{ padding: '4px 0', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
                          ...
                          <code style={{ color: '#FBBF24', fontSize: '0.74rem', background: '#161618', padding: '2px 6px', borderRadius: '4px', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
                            {activeResult.forensics?.formAction}
                          </code>
                        </div>
                        <div style={{ padding: '4px 0' }}>
                          <span style={{ display: 'block', color: '#64748B', marginBottom: '2px' }}>{t.scanner.apkPayload}:</span>
                          <strong style={{ color: activeResult.forensics?.payloadDetected.includes('None') ? '#10B981' : '#F87171' }}>
                    ...
                    {accordionOpen.blacklists && (
                      <div style={{ padding: '0 14px 14px', fontSize: '0.8rem', color: '#94A3B8' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
                          ...
                          <span style={{ color: '#F8FAFC' }}>{activeResult.forensics?.blacklists?.virusTotal}</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
                          <span>Google Safe Browsing:</span>
                          <span style={{ color: '#F8FAFC' }}>{activeResult.forensics?.blacklists?.googleSafeBrowsing}</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0' }}>
                          <span>I4C / SmishWatch:</span>
                          <span style={{ color: '#FBBF24' }}>{activeResult.forensics?.blacklists?.certInSmishWatch}</span>
                        </div>
                      </div>
                    )}
                  </div>
